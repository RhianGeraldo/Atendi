...
import { Plus, Store, Smartphone, Settings, QrCode, Trash2, Users, MoreVertical, Edit2, ChevronRight, Layers, RefreshCw, Loader2, Globe, Facebook, CheckCircle2 } from "lucide-react";
                    ...
                    <div className="p-3 border rounded-lg bg-slate-50 dark:bg-slate-900/50 flex items-center justify-between gap-4 mb-4 text-left">
                      ...
                      <Button 
                        ...
                        onClick={() => {
                          ...
                          const oauthUrl = `https://www.facebook.com/v20.0/dialog/oauth?client_id=${appId}&redirect_uri=${redirectUri}&state=${company?.id}&scope=pages_show_list,pages_messaging,instagram_basic,instagram_manage_messages,whatsapp_business_management,whatsapp_business_messaging`;
