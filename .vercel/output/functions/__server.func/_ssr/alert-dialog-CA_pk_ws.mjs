...
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, d as DialogDescription } from "./dialog-DzIjWjAs.mjs";
...
import { s as Smartphone, w as LoaderCircle, x as CircleCheck, e as Settings, G as Globe, q as Save } from "../_libs/lucide-react.mjs";
class EvoGoClient {
  host;
  token;
  constructor(config) {
  ...
  async sendText(number, text, instanceToken, delay = 1e3) {
  ...
  async sendMedia(number, url, caption, filename, instanceToken, type = "document", delay = 1e3) {
