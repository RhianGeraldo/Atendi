...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BBsfl_YY.mjs");
...
const manifest = {
  "377fa883f3eced871b848252e227566e53f70fb19b65bff5a94781cc59d63023": {
    ...
    importer: () => import("./chat.functions-BeyWK9e5.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-D-8gqfSq.mjs").then((n) => n.r),
    import("./start-CONh4hsr.mjs"),
